...
```
Transform the projection of world to albers.
Then, filter Canada data from world dataset and set a buffer for Canada polygon. The buffer distance is 10000m (10KM). 
```{r}
## world dataset
...
```
Using st_intersection function to get the overlapping area between Canada and NY.
Then, getting the plot for the border area, and using NY polygon as basemap.
```{r}
